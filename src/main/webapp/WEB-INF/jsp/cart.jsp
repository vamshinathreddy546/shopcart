		...
		<div class="col-xs-8">
			<div class="panel panel-inverse">
				...
				<div class="row">
						...
						<div class="col-xs-1">
								<a href="#" class="form-control input-sm"><span class="glyphicon glyphicon-black"> </span></a>
							</div>	
					</div>
					<hr>
				...
				<c:forEach items="${CartList}" var="cart">
					<div class="row">
						...
						<div class="col-xs-1">
								<a href="deleteitem/${cart.id}" class="form-control input-sm"><span class="glyphicon glyphicon-black"> </span></a>
						</div>
